...
async function cargarCitas(token, contenedor) {
  try {
    ...
    if (!data.citas || data.citas.length === 0) {
      ...
      contenedor.innerHTML = `
        <div style="text-align: center; padding: 30px 0;">
          ...
          <p style="opacity: 0.8;">No tienes citas reservadas</p>
        </div>
      `;
      return;
    }

    console.log("Se encontraron", data.citas.length, "citas");

    // Limpiar contenedor
    contenedor.innerHTML = "";
    
    // Crear tarjetas de citas
    data.citas.forEach(function(cita, index) {
      ...
      switch(cita.estado) {
        ...
        case "realizada":
          ...
          break;
        case "cancelada":
          estadoHTML = '<span class="estado-badge cancelada">Cancelada</span>';
          break;
        default:
    ...
    console.log("Todas las citas mostradas correctamente");
...
console.log("Script mis_citas.js cargado");